  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" /dashboard " target="_blank">
        <img src="{{asset('logo-cut.png')}}" width="26px" height="26px" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Petter Tim</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/pets') ? 'active' : '' }}" href="/admin/pets">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/adopt') ? 'active' : '' }}" href="/admin/adopt">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="bi bi-box2-heart ms-2"></i>
            </div>
            <span class="nav-link-text ms-1">Adopt</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/vendor') ? 'active' : '' }}" href="/admin/vendor">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="bi bi-person-hearts ms-2"></i>
            </div>
            <span class="nav-link-text ms-1">Vendor</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/kebutuhan-hewan') ? 'active' : '' }}" href="/admin/kebutuhan-hewan">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="bi bi-bag-heart ms-2"></i>
            </div>
            <span class="nav-link-text ms-1">Kebutuhan Hewan</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/penjualan-hewan') ? 'active' : '' }}" href="/admin/penjualan-hewan">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="bi bi-piggy-bank ms-2"></i>
            </div>
            <span class="nav-link-text ms-1">Penjualan Hewan</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/transaksi-adopsi') ? 'active' : '' }}" href="/admin/transaksi-adopsi">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/transaksi-penjualan') ? 'active' : '' }}" href="/admin/transaksi-penjualan">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="bi bi-receipt ms-2"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/transaksi-pkh') ? 'active' : '' }}" href="/admin/transaksi-pkh">
            <div class="border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="bi bi-receipt ms-2"></i>
            </div>
            <span class="nav-link-text ms-1">Transaksi PKH</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/users') ? 'active' : '' }}" href="/admin/users">
            ...
            <span class="nav-link-text ms-1">User Manajement</span>
          </a>
        </li>
        <li class="nav-item">
