...
<div class="col-12">
  <div class="card">
    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
          ...
          <a href="{{ url('vendor/transaksi-adopsi/create') }}" class="btn btn-primary btn-sm">+ Tambah Transaksi</a>
      </div>
          ...
          <tbody>
            @foreach($transaksi as $index => $adopt)
              <tr>
                ...
                <td>
                    <a href="{{ url('vendor/transaksi-adopsi/'.$adopt->id.'/edit') }}" class="btn btn-sm btn-warning">Edit</a>
                    <a href="{{ url('vendor/transaksi-adopsi/'.$adopt->id) }}" class="btn btn-sm btn-info">Show</a>
                </td>
            </tr>
            @endforeach
          </tbody>
